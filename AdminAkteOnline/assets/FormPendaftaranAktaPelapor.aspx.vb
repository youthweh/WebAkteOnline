...
Partial Class assets_Default
    ...
    Protected Sub btnDaftar_ServerClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnDaftar.ServerClick
        ...
        anak.unggah_foto_ktp_orangtua = "~\assets\uploads\" + fuKTPPelapor.PostedFile.FileName
        fuKTPPelapor.SaveAs(Server.MapPath(anak.unggah_foto_ktp_orangtua))
        anak.unggah_foto_kk = "~\assets\uploads\" + fuKK.PostedFile.FileName
        fuKK.SaveAs(Server.MapPath(anak.unggah_foto_kk))
        anak.unggah_surat_kelahiran = "~\assets\uploads\" + fuSuratKelahiran.PostedFile.FileName
        fuSuratKelahiran.SaveAs(Server.MapPath(anak.unggah_surat_kelahiran))
        anak.unggah_kutipan_akta_nikah = "~\assets\uploads\" + fuAktaNikah.PostedFile.FileName
        fuAktaNikah.SaveAs(Server.MapPath(anak.unggah_kutipan_akta_nikah))
        anak.status = "Sedang Diproses"
