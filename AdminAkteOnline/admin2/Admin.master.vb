...
Partial Class admin2_Admin
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'CHART JENIS LAIN------------------------------------------------------------------------------
        Chart4.Titles.Add("Grafik Kelahiran")
        Chart4.ChartAreas.Clear()
        Chart4.ChartAreas.Add("Default")

        With Chart4.ChartAreas("Default")
            .AxisX.Title = "Jenis kelahiran" 'x label
            .AxisX.MajorGrid.LineColor = Drawing.Color.SkyBlue
            .AxisY.MajorGrid.LineColor = Drawing.Color.SkyBlue
            .AxisY.Title = "Rata-rata kelahiran" 'y label
        End With
        'specify series plot lines
        Chart4.Series.Clear()
        Chart4.Series.Add("plot1")

        Chart4.Series("plot1").ChartType = DataVisualization.Charting.SeriesChartType.Point
        'DATA PEREMPUAN
        Dim Query16 As String
        Dim cmd16 As New SqlCommand
        con2.ConnectionString = "Data Source=LAPTOP-J7REG266\sqlexpress;Initial Catalog=C:\PROGRAM FILES\MICROSOFT SQL SERVER\MSSQL10.SQLEXPRESS\MSSQL\DATA\AKTA_KELAHIRAN.MDF;Integrated Security=True"
        con2.Open()
        '2019-01-01

        Query16 = "SELECT AVG(id_anak) AS rollcount FROM Anak WHERE jenis_kelamin='Perempuan'"

        cmd16 = New SqlCommand(Query16, con2)

        count2 = cmd16.ExecuteScalar

        con2.Close()
        lblPerempuan.Text = count2.ToString()
        'DATA LAKI-LAKI
        Dim Query17 As String
        Dim cmd17 As New SqlCommand
        con2.ConnectionString = "Data Source=LAPTOP-J7REG266\sqlexpress;Initial Catalog=C:\PROGRAM FILES\MICROSOFT SQL SERVER\MSSQL10.SQLEXPRESS\MSSQL\DATA\AKTA_KELAHIRAN.MDF;Integrated Security=True"
        con2.Open()
        '2019-01-01

        Query17 = "SELECT AVG(id_anak) AS rollcount FROM Anak WHERE jenis_kelamin='Laki-laki'"

        cmd17 = New SqlCommand(Query17, con2)
        ...
        'Titik(grafik)
        Chart4.Series("plot1").Points.AddXY("Laki-laki", lblLaki.Text)
        Chart4.Series("plot1").Points.AddXY("Perempuan", lblPerempuan.Text)
