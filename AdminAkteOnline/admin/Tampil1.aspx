...
<body>
    ...
    <div>
        ...
        <br />
        <asp:Label ID="lblPerempuan" runat="server" Text="Label"></asp:Label>
        <br />
        <asp:Label ID="lblLaki" runat="server" Text="Label"></asp:Label>
        <br />
        <br />
        <br />
        <br />
        ...
        <asp:SqlDataSource ID="SqlDataSource6" runat="server" 
            ...
            SelectCommand="SELECT * FROM [Pelapor]"></asp:SqlDataSource>
