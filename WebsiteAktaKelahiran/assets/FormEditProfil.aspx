...
<br />
    ...
    <div class="col-md-8 col-md-offset-2">
        ...
        <div class="form-body bg-light">
            ...
            <asp:SqlDataSource ID="sdsInsert" runat="server" ConnectionString="<%$ ConnectionStrings:akta_kelahiranLogin %>"
                InsertCommand="INSERT INTO Pelapor(nik, nama_lengkap, no_kk, email, no_hp, password) VALUES (@nik,@nama,@no_kk,@email,@no_hp,@password)">
                <InsertParameters>
                    <asp:ControlParameter ControlID="txtNIK" Name="nik" PropertyName="Text" />
                    <asp:ControlParameter Name="nama" ControlID="txtNama" PropertyName="Text" />
                    <asp:ControlParameter ControlID="txtEmail" Name="email" PropertyName="Text" />
                    <asp:ControlParameter ControlID="txtNoHP" Name="no_hp" PropertyName="Text" />
                    <asp:ControlParameter ControlID="txtNoKK" Name="no_kk" PropertyName="Text" />
